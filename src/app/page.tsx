      ...
      <div className="max-w-7xl mx-auto">
        ...
        <footer className="mt-16 pt-12 border-t border-slate-800 pb-12 text-center space-y-6">
          ...
          <p className="max-w-2xl mx-auto text-[9px] text-slate-600 leading-relaxed uppercase">
            Dota 2 is a registered trademark of Valve Corporation. This site is
            not affiliated with or endorsed by Valve. All game assets, images,
            and names are the property of their respective owners. Built for the
            community with love.
          </p>
        </footer>
      </div>
