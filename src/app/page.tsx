          ...
          <div className="lg:col-span-1 space-y-6">
                ...
                <div className="space-y-3">
                  {suggestions.map((s, idx) => {
                    ...
                    return (
                      <div
                        key={hero.id}
                        className="flex items-center gap-3 p-2 bg-slate-800/50 rounded hover:bg-slate-800 transition-colors cursor-pointer group"
                      ...
                      >
                        ...
                        <img
                          ...
                          className="w-12 aspect-[16/9] object-cover rounded shadow"
                          alt=""
                        />
                        <div className="flex-1 overflow-hidden">
                          ...
                          <div
                            className={`text-[10px] ${s.score > 0 ? "text-green-500" : "text-red-500"}`}
                          >
            ...
            <div className="bg-slate-900 p-4 rounded-lg border border-slate-800">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                We analyze Real-time data from OpenDota API. When you pick enemy
                heroes, we calculate which heroes have the highest win rate
                against them in the current patch.
              </p>
            </div>
          </div>
        </div>
